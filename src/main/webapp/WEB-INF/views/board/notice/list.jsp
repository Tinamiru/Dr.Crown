...
<div class="container-fluid">
				...
				<c:forEach items="${noticeList}" var="notice">
					<tbody>
						<tr>
							...
							<td>
								<c:choose>
									<c:when test="${notice.noticeCategory == '0'}"><span class="btn-square btn-xs btn-dark">전체</span></c:when>
									<c:when test="${notice.noticeCategory == '1'}"><span class="btn-square btn-xs btn-success">전문의</span></c:when>
									<c:when test="${notice.noticeCategory == '2'}"><span class="btn-square btn-xs btn-info">직원</span></c:when>
	...
	<div class = "row justify-content-end pr-5">
		<div>
			<button type="button" class="btn btn-square btn-primary" style="position: absolute; right: 4vw;">글쓰기</button>
		</div>
	</div>
</div>
