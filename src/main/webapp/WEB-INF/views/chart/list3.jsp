...
function detailDocument(data){
	 window.open('/document/registForm?pNo='+data,'문서발급','height=700, width=670');
}
</script>
...
<script>
	...
	function dzAdd(){
		...
		var newDzNode = dzNode;
		var dzNum = newDzNode.querySelector('.dzAddNode').textContent;
		var dzCode = newDzNode.querySelector('.dzCodeInSearch').textContent;
		var dzKoName = newDzNode.querySelector('.dzKoName').textContent;
...
function registCureDetail(){
	...
	// 처치목록 갯수
	var tlRowCount = tlTable.rows.length;
	// 상병목록 갯수
	var dzRowCount = dzTable.rows.length;
