                    ...
                    <div class="authincation-content loginBoxBackground">
                                ...
                                <div class="auth-form loginBoxBackground text-left">
                                        <div class="input-group mb-3">
                                        	<label class="text-white"><strong>사번</strong></label>
                                        	 <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control-input"  placeholder="사번을 입력하세요">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="email" class="form-control form-control-input" value="" placeholder="이메일을 입력하세요">
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="password" class="form-control form-control-input" value="" name="pwd" id="pwd" placeholder="8~16자 영문 대 소문자, 숫자, 특수문자를 사용하세요.">
                                        </div>
                                          <div class="form-group">
                                            <input type="password" class="form-control form-control-input" onkeyup="check_pw()" name="pwd_re" id="pwd_re" value="" placeholder="비밀번호 확인">
                        ...
                        <div class="row no-gutters justify-content-right" style="float: right;">
		                        <div class="text-center">
		                            <button type="submit" class="loginBtn btn btn-block">회원가입</button>
		                        </div>
		                        <div></div>
	                         	<div class="text-center">
