...
<script>
window.bookingCclist2 =function (pNo){  
		  ...
		  success : function(data){
			  ...
			  if(data.patList.patientsearchList < 1 || keyword==""){
				...
				$.each(data.patList.patientsearchList, function(index,value){
					...
					s += '<tr style="cursor:pointer; width:100%; font-size:20px;" onClick=patient('+value.pno+');curelist('+value.pno+');bookingCclist('+value.pno+');printAjax('+value.pno+');prescriptionAjax('+value.pno+');bookingCclist2('+value.pno+');>';
