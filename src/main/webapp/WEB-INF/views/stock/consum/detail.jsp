					...
					<div style="width: 100%; height: 80%; background-color: white;">
						<div id="detailFrameRightUpContent">
							...
							<div class="row" id="detailListRow" >
								...
								<input type="text"  readonly="readonly" value="${stock.conCode}">
							</div>
							...
							<div class="row" id="detailListRow" >
								...
								<input type="text"  readonly="readonly" value="${stock.conName}">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									단가
								</div>
								<input type="text"  readonly="readonly" value="${stock.conPrice}원">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									재고
								</div>
								<input type="text"  readonly="readonly" value="${stock.conStock}">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									단위
								</div>
								<input type="text"  readonly="readonly" value="${stock.conUnit}">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									업체명
								</div>
								<input type="text"  readonly="readonly" value="${stock.conMaker}">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									유통사
								</div>
								<input type="text"  readonly="readonly" value="${stock.conDistr}">
							</div>
							<div class="row" id="detailListRow" >
								<div>
									입고일
								...
								<input type="text"  readonly="readonly" 
										value="<fmt:formatDate value="${stock.conDate }" pattern="yyyy-MM-dd" />" />
							</div>
					</div>
