			...
			<div class="col-sm-5">
				<div class="row justify-content-center" style="padding-bottom: 8vh;">
					<section class="content" style="height: 40vh; width: 95%;">
						<section class="content-header">
							...
							<div class="container-fluid" >
								<h2 style="text-align: center; font-weight: bolder; font-size: 27px;">소모품 주문 신청</h2>
							</div>
						...
						<div class="card" style="overflow-y: scroll;">
							<div class="card-body" style="text-align: center; font-size: 11px; ">
								<div class="row">
									<div class="col-sm-12">
										<form name="" role="form" class="form-horizontal" action="/consum/listSuccess" method="post">
				...
				<div class="row justify-content-center" style="padding-bottom: 8vh;">
					<section class="content" style="height: 40vh; width: 95%;" >
						<section class="content-header">
							<div class="container-fluid">
								<h2 style="text-align: center; font-weight: bolder; font-size: 27px;">소모품 주문 목록</h2>
							</div>
						</section>
						<div class="card" style="overflow-y: scroll;">
...
var rowData = [
	<c:forEach items="${consumeList}" var="stock">
		{ 
		  ...
		  unit: "${stock.conUnit}", 
		  maker: "${stock.conMaker}", 
		  date: "<fmt:formatDate value='${stock.conDate }' pattern='yyyy-MM-dd'/>",
		},
	</c:forEach>
...
// 	console.log(rowDataClicked1[3].code);
	...
	$.ajax({
		url: "/stock/consum/listJson",
		method : "GET",
		data : {"conCode" : clickData.data.code},
		...
		success:function(data)
		{
			...
			//console.log(data)
				tr += 
				  ...
				  "</td><td>"+data.conCode + 
				  "</td><td>"+data.conName +
				  "</td><td>"+'<input type="text" style="width: 2vw;" name="conStock" placeholder="'+data.conUnit+'" value="" >'+
				  "</td><td>"+data.conMaker +
				  "</td><td>"+'<div id="number_textalign">'+data.conPrice +'</div>'+
	...
	function detail(data) {
		...
		window.open('detail?from=list&conCode='+data.data.code,'detail','height=600, width=800, left='+ popupX + ', top='+ popupY);
	}
