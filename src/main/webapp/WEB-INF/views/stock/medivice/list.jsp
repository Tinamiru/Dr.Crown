				...
				<section class="content">
					<section class="content-header" >
						<div class="container-fluid" >
							<h2 style="text-align: center; font-weight: bolder; font-size: 27px;">기자재 재고 현황</h2>
						</div>
					</section>
			...
			<div class="col-sm-5">
				<div class="row justify-content-center" style="padding-bottom: 8vh;">
					<section class="content" style="height: 40vh; width: 95%;">
						<section class="content-header">
							...
							<div class="container-fluid" >
								<h2 style="text-align: center; font-weight: bolder; font-size: 27px;">기자재 주문 신청</h2>
							</div>
				...
				<div class="row justify-content-center" style="padding-bottom: 8vh;">
					<section class="content" style="height: 40vh; width: 95%;" >
						<section class="content-header">
							<div class="container-fluid">
								<h2 style="text-align: center; font-weight: bolder; font-size: 27px;">기자재 주문 목록</h2>
							</div>
						</section>
						<div class="card" style="overflow-y: scroll;">
...
var columnDefs = [
		...
		{ headerName:"품목명", field: "name" , sortable : true, filter : true, width : 220},
		{ headerName:"수량", field: "stock" , sortable : true, /* filter : true ,*/ width : 80, type: 'rightAligned'},
		{ headerName:"업체명", field: "maker" , sortable : true, filter : true, width : 170},
